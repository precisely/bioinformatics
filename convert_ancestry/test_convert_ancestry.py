...
with description('Testing Ancestry.com -> 23andme converter:') as testConverter:
    with it('Bad filepath for input_generator'):
        ...
        expects.expect(lambda: next(gen)).to(expects.raise_error(IOError))
    
    with it('Creating input/output Generator and checking output file exists'):
        outfile_name = 'convert_ancestry/mamba_out/test_outputs/out_23andMe.txt'
        in_generator = conv.input_file_generator('convert_ancestry/mamba_out/AncestryDNA.txt')
